...
assert.equal(endpoint.conversationId("https://chatgpt.com:8443/backend-api/conversations/test-port?num_turns=10"), "test-port", "HTTPS ChatGPT test ports must retain exact-host endpoint semantics");
...
for (const url of [
  ...
  "https://chatgpt.com/backend-api/conversations/foo%2Fbar",
