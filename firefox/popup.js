...
async function initialize() {
  const saved = await browser.storage.local.get({ enabled: true, mode: "windowed-visible", maxDisplayMessages: 64, showGuardNotice: true, stallRecoveryEnabled: true, cgTotals: EMPTY_TOTALS, cgLastIssue: null });
